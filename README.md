## create-react-app with Redux, Redux Form, Material-UI, ESLint - Airbnb, CSS Modules
...
## Code styling rules ESLint - Airbnb React/JSX Style Guide
...
from [`src/Auth.js`](src/Auth.js).

If you had previously enabled service workers in your production deployment and
have decided that you would like to disable them for all your existing users,
you can swap out the call to `serviceWorkerRegistration.register()` in
[`src/Auth.js`](src/Auth.js) with a call to `serviceWorkerRegistration.unregister()`.
